...
# The fields we want
wanted_fields = ['Common Name(s)', 'Scientific Name', 'Distribution',
                 'Tree Size', 'Average Dried Weight', 'Janka Hardness',
                 'Modulus of Rupture', 'Elastic Modulus',
                 'Crushing Strength', 'Shrinkage', 'Rot Resistance',
                 'Workability', 'Common Uses'
                ]
